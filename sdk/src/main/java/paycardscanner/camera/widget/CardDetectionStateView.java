...
public class CardDetectionStateView extends View {
    ...
    private void init(final Context context) {
        ...
        int mBackgroundDrawableColor = context.getResources().getColor(R.color.paycardscanner_card_shadow_color);
        ...
        mCardGradientDrawable = ContextCompat.getDrawable(context, R.drawable.paycardscanner_frame_rect_gradient);
    ...
    private void initCornerDrawables(Context context) {
        Drawable topLeftCorner = getTintedDrawable(context, R.drawable.paycardscanner_ic_top_left_rounded_corner, mainColor);
        Matrix m = new Matrix();
