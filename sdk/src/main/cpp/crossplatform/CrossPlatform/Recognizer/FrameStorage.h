...
public:
    ...
    virtual bool SetRawFrame(const Mat& rawFrame, const vector<ParametricLine>& edges, PayCardScannerRecognizerOrientation orientation);
    
    virtual bool NormalizeMatrix(const Mat& matrix, const vector<ParametricLine>& edges, Mat& resultMatrix);
    
    virtual void SetRawY(const void* rawY, const void* rawUV, const vector<ParametricLine>& edges, PayCardScannerRecognizerOrientation orientation);
    ...
    virtual const PayCardScannerRecognizerOrientation GetYUVOrientation();
...
private:
    ...
    PayCardScannerRecognizerOrientation _grayOrientation;
    PayCardScannerRecognizerOrientation _yuvOrientation;
};
