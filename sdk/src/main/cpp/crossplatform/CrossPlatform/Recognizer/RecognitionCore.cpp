...
CRecognitionCore::CRecognitionCore(const shared_ptr<IRecognitionCoreDelegate>& delegate, const shared_ptr<ITorchDelegate>& torchDelegate) : _delegate(delegate), _orientation(PayCardScannerRecognizerOrientationPortrait), _mode(PayCardScannerRecognizerModeNone), _deployed(false)
{
    _isIdle.store(false);
    _isBusy = false;
...
void CRecognitionCore::SetRecognitionMode(PayCardScannerRecognizerMode flag)
{
    _mode = flag;

    if (_mode & PayCardScannerRecognizerModeNumber) {
...
//// disable date recognition
    if (_mode & PayCardScannerRecognizerModeDate) {
...
//// disable name recognition
    if (_mode & PayCardScannerRecognizerModeName) {
...
{
    if (_mode == PayCardScannerRecognizerModeNone) return;
...
void CRecognitionCore::SetOrientation(PayCardScannerRecognizerOrientation orientation)
{
...
void CRecognitionCore::Recognize()
{
    if (auto recognitionResult = _recognitionResult.lock()) {
        ...
        if (_mode & PayCardScannerRecognizerModeDate || _mode & PayCardScannerRecognizerModeNumber) {
            _delegate->RecognitionDidFinish(recognitionResult, (PayCardScannerRecognizerMode)(PayCardScannerRecognizerModeNumber | PayCardScannerRecognizerModeDate));
            
            if(_mode & PayCardScannerRecognizerModeGrabCardImage) {
        ...
        _delegate->RecognitionDidFinish(recognitionResult, PayCardScannerRecognizerModeName);
...
cv::Mat CRecognitionCore::CaptureView()
{
    ...
    if(auto frameStorage = _frameStorage.lock()) {
        if(auto edgesDetector = _edgesDetector.lock()) {
            ...
            PayCardScannerRecognizerOrientation orientation = frameStorage->GetYUVOrientation();
            
            if (orientation != PayCardScannerRecognizerOrientationPortraitUpsideDown &&
                orientation != PayCardScannerRecognizerOrientationPortrait) {
