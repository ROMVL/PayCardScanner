...
CEdgesDetector::CEdgesDetector(shared_ptr<IFrameStorage> frameStorage) : _lineFlags(DetectedLineNoneFlag), _orientation(PayCardScannerRecognizerOrientationUnknown)
{
}
...
const Rect CEdgesDetector::CalcWorkingArea(Size frameSize, int captureAreaWidth,
                                           PayCardScannerRecognizerOrientation orienation)
{
    ...
    if (orienation == PayCardScannerRecognizerOrientationPortrait || orienation == PayCardScannerRecognizerOrientationPortraitUpsideDown) {
...
{
    if (_orientation == PayCardScannerRecognizerOrientationUnknown)
    ...
    if(BestLine(&topLine, topEdge, false)) {
        ...
        if (_orientation == PayCardScannerRecognizerOrientationPortrait || _orientation == PayCardScannerRecognizerOrientationPortraitUpsideDown) {
